...
const DialogItem = ({_id, roomId, user, partner, author, read, text, currentDialogId, lastMessage, isMe}) => {
    return (
        <Link to={`/personal-account/dialog/${roomId}`} className='dialog__item-link'>
